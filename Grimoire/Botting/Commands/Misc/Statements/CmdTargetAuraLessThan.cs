...
namespace Grimoire.Botting.Commands.Misc.Statements
{
	public class CmdTargetAuraLessThan : StatementCommand, IBotCommand
	{
		...
		public Task Execute(IBotEngine instance)
		{
			...
			{
				int auraValue2 = Player.GetAuras(false, Aura2);
				LogForm.Instance.AppendDebug($"[TargetAuraLessThan] Aura2 '{Aura2}': {auraValue2}");
			...
			if (finalCondition)
			{
				LogForm.Instance.AppendDebug($"[TargetAuraLessThan] Condition met");
